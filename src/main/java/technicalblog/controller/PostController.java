...
public class PostController {
    ...
    /**
    This Model object is provided by Spring to pass data from the controller to the Thymeleaf
    template (posts.html), so the template can access the posts data using the given reference
    key “posts”.
     */
